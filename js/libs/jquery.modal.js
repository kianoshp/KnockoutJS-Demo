			...
			*/
			init: function(options) {
				var defaults = {
						'height': 100,
						'width': 200,
						'top': document.body.scrollTop  + ($(window).height()/2 - (_.isNaN(options.height/2) ? 150 : options.height/2)),
						'left': $(window).width()/2 - (_.isNaN(options.width/2) ? 150 : options.width/2),
						'topPosition': 0,
						'leftPosition': 0,
